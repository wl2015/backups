...
<title>评论管理</title>
<link rel="stylesheet" type="text/css" href="res/css/admin/commentManage.css">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="javascript:void(0)" class="editComment">编辑</a><a href="javascript:void(0)" class="saveComment" onclick="saveGoodComment('${item.commentId }')">保存</a></td>
          <td><a href="javascript:void(0)" onclick="deleteGoodComment('${item.commentId}')">删除</a></td>
         <%-- <td><input type="checkbox" value="${item.commentId}" name=""/></td> --%>
        </tr>
        </c:forEach>
      </tbody>
