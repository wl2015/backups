    ...
    */  
    ...
    Calendar.prototype.draw = function() {     
      ...
      if("d" == this.type){  
        ...
        lis += "<li style='width:30%;'><span id='selectThisYear' class='selectThisYear'>" + this.date.getFullYear() + "</span>" + Calendar.language["title"][1][1] + "</li>";  
        if(0 == this.lang){  
            lis += "<li style='width:20%;'><span id='selectThisMonth' class='selectThisMonth'>" + Calendar.language["months"][1][this.date.getMonth()] + "</span></li>";  
        }else{  
            lis += "<li style='width:20%;'><span id='selectThisMonth' class='selectThisMonth'>" + (this.date.getMonth() +1) + "</span>" + Calendar.language["title"][1][1] + "</li>";  
        }  
        ...
        lis += "<li id='selectCurrent' style='width:45%;' title='Today'>" + Calendar.language.today[1][1] +"</li>";  
      }else{  
        lis += "<li style='width:74%;'><span id='selectThisYear' class='selectThisYear'>" + this.date.getFullYear() + "</span>" + Calendar.language["title"][1][1] + "</li>";  
        lis += "<li id='NextYear' class='mark' style='width:12%;' title='Next Year'>»</li></ul></div>";  
        lis += "<div class='calendarBody'>";  
