...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <div class="left">
    <button class="left_btn btn-1" style="background-color: #26A65B" onclick="window.location.href='<%=path %>/user/toUnReadedMessages'">未读消息</button>
    <button class="left_btn btn-2" onclick="window.location.href='<%=path %>/user/toReadedMessages'">已读消息</button>
    <button class="left_btn btn-3" onclick="window.location.href='<%=path %>/user/toSendedMessages'">发送消息</button>
  </div>
