...
public class CommonServiceImpl implements CommonService {
	...
	private static final String MessageUserName = "shangwangding";//短信平台用户名
	private static final String KEY = "6dbfabbb41ba5f9137ef";//短信平台秘钥
	 ...
	 * */
	public String doSendPhoneMessage(String phoneNum, String msg) throws Exception {
		...
		NameValuePair[] data ={ new NameValuePair("Uid", MessageUserName),
				...
				//new NameValuePair("smsText", "上网定婚礼平台验证码:"+code+",请您及时完成验证。如非本人操作请忽略本短信。")};
		...
		if (sendSuccess == statusCode) {
			log.info("成功发送短信验证码[statusCode:" + statusCode + "][返回数据:" + sendResult + "][消息:"+ msg + "][电话号码:" + phoneNum +"]");
