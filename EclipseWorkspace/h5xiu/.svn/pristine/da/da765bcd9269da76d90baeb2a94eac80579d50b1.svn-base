...
<body>
	<div id="page-error">
		...
		<div class="img-403">403</div>
		<h2 class="msg-error">403 Error - Forbidden</h2>
		<p>
			<span class="back">
				<a id="errorFlag" href="javascript:void(0)"><span id="time">5</span>秒后，返回上网定首页</a>
			</span>
		</p>
	</div>
</body>
