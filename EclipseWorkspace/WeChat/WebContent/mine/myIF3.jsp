...
<html>
  <head>
    ...
    <title>My JSP 'myIF3.jsp' starting page</title>
...
<div class="body">
<s:form action="UserInfoAction_saveOrUpdatePass" method="post">
<center>
<div class="body11"></div>
<div class="border0"></div>

<div class="body11">
	<div class="body22 font-s-3">新密码
...
<div class="body11">
	<div class="body22 font-s-3">确认密码
		<input type="password"  />
	</div>
</div>
...
<s:form action="UserInfoAction_saveOrUpdatePass" method="post">
<div class="body">
	<div class="margin-4 font-s-2">当前密码</div>
	<div><input type="text" class="input1 input-text2 margin-l-6" style="width:80%"/></div>

	<div class="margin-5 font-s-2">新密码</div>
	<div><input type="password" name="user.password" class="input1 input-text2 margin-l-6" style="width:80%"/></div>

	<div class="margin-5 font-s-2">确认新密码</div>
	<div><input type="password" class="input1 input-text2 margin-l-6" style="width:80%"/></div>
	<div style="height:12em;margin-top:-2em">
		<div>
		<input type="submit" value="提交" class="tijiao"/></div>
