...
<html>
  <head>
    ...
    <title>My JSP 'myIF2.jsp' starting page</title>
...
<s:form action="UserInfoAction_saveOrUpdate" method="post">
<center> 
<div class="body11">
	<div class="body22 font-s-3">电子邮件
...
<div class="body">
	...
	<div class="margin-4 font-s-2">电子邮件</div>
	<div><input type="text" value="${user.email}" name="user.email" class="input1 input-text margin-l-6" style="width:80%"/></div>
